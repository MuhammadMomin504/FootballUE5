...
struct Z_CompiledInDeferFile_FID_muhammadmomin_Documents_Folders_Development_UEGitProjects_FootballUE5_Soccer_Source_Soccer_Public_Character_MySoccerCharacter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMySoccerCharacter, AMySoccerCharacter::StaticClass, TEXT("AMySoccerCharacter"), &Z_Registration_Info_UClass_AMySoccerCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMySoccerCharacter), 3779862134U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_muhammadmomin_Documents_Folders_Development_UEGitProjects_FootballUE5_Soccer_Source_Soccer_Public_Character_MySoccerCharacter_h_427815050(TEXT("/Script/Soccer"),
